...
//2.8.0
define('_MI_SYSTEM_PREFERENCE_ACTIVE_LANGUAGES', 'Activa l\''administració d\''idiomes');
define('_MI_SYSTEM_PREFERENCE_ACTIVE_LANGUAGES_DESC', 'Gestioneu el registre de configuracions regionals, els paquets d\''idioma, les comprovacions d\''estat i les substitucions de traducció del lloc.');
define('_MI_SYSTEM_BNAME14', 'Selector d\''idioma');
